...
std::string stdb::get_zero_padded_string(int n, int w) {
...
stdb::stdb() {
    ...
    std::filesystem::create_directory("fffe0000/music");
}

void stdb::create_soundtrack(std::wstring name, std::string folder) {
